...
def get_stft_autoencoder(sr=22050, duration=1.0):
    ...
    m = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(32, 3, activation='tanh'))(m)
    ...
    p = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(32, 3, activation='tanh'))(p)
