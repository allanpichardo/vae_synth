...
def get_model(latent_dim=8, sr=44100, duration=1.0, spectrogram_shape=(80, 1025), n_fft=2048):
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(24, 9, dilation_rate=1, activation='tanh', padding='same'))(img_inputs)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(24, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(24, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(36, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(36, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(36, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(54, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(54, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(54, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(81, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(81, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(81, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(121, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(121, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(121, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(182, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(182, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(182, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.MaxPooling2D()(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(273, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(273, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(273, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(273, 5, dilation_rate=4, activation='tanh', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(273, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(273, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(182, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(182, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(182, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.ZeroPadding2D(padding=[(0, 1), (0, 0)])(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(121, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(121, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(121, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(81, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(81, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(81, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(54, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(54, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(54, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(36, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(36, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(36, 9, dilation_rate=1, activation='elu', padding='same'))(x)
    x = layers.UpSampling2D(interpolation="nearest")(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(24, 5, dilation_rate=4, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(24, 7, dilation_rate=2, activation='elu', padding='same'))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1DTranspose(24, 9, dilation_rate=1, activation='tanh', padding='same'))(x)
